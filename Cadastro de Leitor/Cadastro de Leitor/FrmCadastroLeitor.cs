...
namespace Cadastro_de_Leitor
{
    public partial class FrmCadastroLeitor : Form
    {
        ...
        private void txtNomeLeitor_TextChanged(object sender, EventArgs e)
        {
            ...
            {
                label16.Visible = true;  // Mostra a label se o TextBox estiver vazio
            }
            else
            {
                label16.Visible = false; // Oculta a label se o TextBox estiver preenchido
            }
        }
        ...
        private void txtCpf_MaskInputRejected(object sender, MaskInputRejectedEventArgs e)
        {
            if (txtCpf.Mask == "")
            {
                label22.Visible = true;  // Mostra a label se o TextBox estiver vazio
            }
            else
            {
                label22.Visible = false; // Oculta a label se o TextBox estiver preenchido
            }
        }

        private void txtsexoLeitor_SelectedIndexChanged(object sender, EventArgs e)
        {
            if (txtsexoLeitor.Text == "")
            {
                label17.Visible = true;  // Mostra a label se o TextBox estiver vazio
            }
            else
            {
                label17.Visible = false; // Oculta a label se o TextBox estiver preenchido
            }
        }
        ...
        private void txtRua_TextChanged(object sender, EventArgs e)
        {
            if (txtRua.Text == "")
            {
                label9.Visible = true;  // Mostra a label se o TextBox estiver vazio
            }
            else
            {
                label9.Visible = false; // Oculta a label se o TextBox estiver preenchido
            }
        }
        ...
        private void txtCidade_TextChanged(object sender, EventArgs e)
        {
            if (txtCidade.Text == "")
            {
                label21.Visible = true;  // Mostra a label se o TextBox estiver vazio
            }
            else
            {
                label21.Visible = false; // Oculta a label se o TextBox estiver preenchido
            }
        }
        ...
        private void txtBairro_TextChanged(object sender, EventArgs e)
        {
            if (txtBairro.Text == "")
            {
                label20.Visible = true;  // Mostra a label se o TextBox estiver vazio
            }
            else
            {
                label20.Visible = false; // Oculta a label se o TextBox estiver preenchido
            }
        }
    }   
}  
